#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('c:\\Users\\zane0\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.438\\out\\buildHook\\index.js').default({tool: 'live-server', checkSum: '208a0d6aaf047c9acafe98Ck8CSgZbWFNTBQFUWlYHVgRVCgtc', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/zane0/.vscode/extensions/wallabyjs.console-ninja-1.0.438/out/buildHook/index.js').then(m => m.default.default({tool: 'live-server', checkSum: '208a0d6aaf047c9acafe98Ck8CSgZbWFNTBQFUWlYHVgRVCgtc', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
