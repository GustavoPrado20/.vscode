#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('c:\\Users\\zane0\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.440\\out\\buildHook\\index.js').default({tool: 'live-server', checkSum: '209d1543852ede58e1179eC0oDGwQJCwUCAwFRDFlRAgJWDVEN', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/zane0/.vscode/extensions/wallabyjs.console-ninja-1.0.440/out/buildHook/index.js').then(m => m.default.default({tool: 'live-server', checkSum: '209d1543852ede58e1179eC0oDGwQJCwUCAwFRDFlRAgJWDVEN', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
